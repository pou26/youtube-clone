...
const ChannelCreationForm = ({ userId, onSuccess, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Send with appropriate content type for multipart/form-data
    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-40">
      <div className="bg-gray-900 rounded-lg w-full max-w-md p-6 text-white">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label className="text-gray-400 text-sm mb-1 block">Channel Handle</label>
            <input
              type="text"
              name="handle"
          ...
          <div className="mb-4">
            <label className="text-gray-400 text-sm mb-1 block">Channel Banner</label>
            <input
              type="file"
              accept="image/*"
